...
pf2ad: {
    url: "https://github.com/aislanlaranja/packages/tree/11.1",
    mirror_type: "https",
    enabled: yes
}
EOF
...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/aislanlaranja/pf2ad/2.4.5-SAMBA4/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/aislanlaranja/pf2ad/2.4.5-SAMBA4/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/aislanlaranja/pf2ad/2.4.5-SAMBA4/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/pf2ad/pf2ad/2.4.5-SAMBA4/squid.inc
